...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="{{ asset('css/surat.css') }}">
</head>
<body>
    <div class="header">
        <table style="margin-bottom: 5px; width:100%">
            <tr>
                <td style="width: 10%; text-align:left;"><img src="{{ asset('logo-buleleng.png') }}" alt="Kabupaten Buleleng"></td>
                <td style="width: 80%"><p class="text-big"><b>PEMERINTAH KABUPATEN BULELENG</b></p>
                ...
                <td style="width: 10%; text-align: right;"><img src="{{ asset('logo-desa.png') }}" alt="Desa Tembok"></td>
            </tr>
        </table>
        <hr>
    </div>
